...
class AddPrepayAccountResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "AccountNumber", "CreateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddPrepayAccountResponse from a dict"""
        if obj is None:
            return None
