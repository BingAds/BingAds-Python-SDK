...
class SearchAccountsResponse(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[Optional[AdvertiserAccount]]] = Field(default=None, alias="Accounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchAccountsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Accounts": [AdvertiserAccount.from_dict(_item) for _item in obj["Accounts"]] if obj.get("Accounts") is not None else None
        })
        return _obj
