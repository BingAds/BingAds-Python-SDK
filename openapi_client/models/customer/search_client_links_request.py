...
class SearchClientLinksRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Predicates", "Ordering", "PageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchClientLinksRequest from a dict"""
        if obj is None:
            return None
