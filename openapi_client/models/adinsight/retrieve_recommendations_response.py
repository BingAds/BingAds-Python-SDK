...
class RetrieveRecommendationsResponse(BaseModel):
    """
    RetrieveRecommendationsResponse
    """ # noqa: E501
    recommendations: Optional[List[Optional[RecommendationBase]]] = Field(default=None, alias="Recommendations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveRecommendationsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Recommendations": [RecommendationBase.from_dict(_item) for _item in obj["Recommendations"]] if obj.get("Recommendations") is not None else None
        })
        return _obj
