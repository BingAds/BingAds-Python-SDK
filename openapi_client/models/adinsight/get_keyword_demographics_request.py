...
class GetKeywordDemographicsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Keywords", "Language", "PublisherCountry", "Device"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetKeywordDemographicsRequest from a dict"""
        if obj is None:
            return None
