...
class SelectionOflong(BaseModel):
    """
    SelectionOflong
    """ # noqa: E501
    includes: Optional[List[StrictStr]] = Field(default=None, alias="Includes")
    excludes: Optional[List[StrictStr]] = Field(default=None, alias="Excludes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelectionOflong from a dict"""
        if obj is None:
            return None
