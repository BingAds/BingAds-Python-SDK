...
class KeywordLocation(BaseModel):
    """
    KeywordLocation
    """ # noqa: E501
    device: Optional[StrictStr] = Field(default=None, alias="Device")
    location: Optional[StrictStr] = Field(default=None, alias="Location")
    percentage: Optional[StrictFloat] = Field(default=None, alias="Percentage")
    __properties: ClassVar[List[str]] = ["Device", "Location", "Percentage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordLocation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Device": obj.get("Device") if obj.get("Device") is not None else None,
                        ...
                        "Percentage": obj.get("Percentage") if obj.get("Percentage") is not None else None
        })
        return _obj
