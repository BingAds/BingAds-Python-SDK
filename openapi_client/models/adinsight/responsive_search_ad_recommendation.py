...
class ResponsiveSearchAdRecommendation(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='ResponsiveSearchAdRecommendation', alias="Type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SuggestedAd": SuggestedResponsiveSearchAd.from_dict(obj["SuggestedAd"]) if obj.get("SuggestedAd") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'ResponsiveSearchAdRecommendation',
