...
class BroadMatchKeywordOpportunity(KeywordOpportunity):
    """
    ...
    click_share: Optional[StrictFloat] = Field(default=None, alias="ClickShare")
    ...
    reference_keyword_id: Optional[StrictStr] = Field(default=None, alias="ReferenceKeywordId")
    reference_keyword_bid: Optional[StrictFloat] = Field(default=None, alias="ReferenceKeywordBid")
    reference_keyword_match_type: Optional[StrictInt] = Field(default=None, alias="ReferenceKeywordMatchType")
    impression_share: Optional[StrictFloat] = Field(default=None, alias="ImpressionShare")
    search_query_kpis: Optional[List[Optional[BroadMatchSearchQueryKPI]]] = Field(default=None, alias="SearchQueryKPIs")
    __properties: ClassVar[List[str]] = ["AdGroupId", "CampaignId", "AdGroupName", "CampaignName", "MatchType", "SuggestedKeyword", "SuggestedBid", "MonthlySearches", "Competition", "EstimatedIncreaseInClicks", "EstimatedIncreaseInCost", "EstimatedIncreaseInImpressions", "OpportunityKey", "Type", "ClickShare", "AverageCTR", "AverageCPC", "ReferenceKeywordId", "ReferenceKeywordBid", "ReferenceKeywordMatchType", "ImpressionShare", "SearchQueryKPIs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BroadMatchKeywordOpportunity from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in search_query_kpis (list)
        _items = []
        if self.search_query_kpis:
            for _item_search_query_kpis in self.search_query_kpis:
                if _item_search_query_kpis:
                    _items.append(_item_search_query_kpis.to_dict())
            _dict['SearchQueryKpis'] = _items
        ...
        # set to None if click_share (nullable) is None
        # and model_fields_set contains the field
        if self.click_share is None and "click_share" in self.model_fields_set:
            _dict['ClickShare'] = None
        ...
        # set to None if reference_keyword_id (nullable) is None
        # and model_fields_set contains the field
        if self.reference_keyword_id is None and "reference_keyword_id" in self.model_fields_set:
            _dict['ReferenceKeywordId'] = None

        # set to None if reference_keyword_bid (nullable) is None
        # and model_fields_set contains the field
        if self.reference_keyword_bid is None and "reference_keyword_bid" in self.model_fields_set:
            _dict['ReferenceKeywordBid'] = None

        # set to None if reference_keyword_match_type (nullable) is None
        # and model_fields_set contains the field
        if self.reference_keyword_match_type is None and "reference_keyword_match_type" in self.model_fields_set:
            _dict['ReferenceKeywordMatchType'] = None
        ...
        # set to None if search_query_kpis (nullable) is None
        # and model_fields_set contains the field
        if self.search_query_kpis is None and "search_query_kpis" in self.model_fields_set:
            _dict['SearchQueryKPIs'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BroadMatchKeywordOpportunity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AdGroupId": obj.get("AdGroupId") if obj.get("AdGroupId") is not None else None,
                        ...
                        "ClickShare": obj.get("ClickShare") if obj.get("ClickShare") is not None else None,
                        ...
                        "ReferenceKeywordId": obj.get("ReferenceKeywordId") if obj.get("ReferenceKeywordId") is not None else None,
                        "ReferenceKeywordBid": obj.get("ReferenceKeywordBid") if obj.get("ReferenceKeywordBid") is not None else None,
                        "ReferenceKeywordMatchType": obj.get("ReferenceKeywordMatchType") if obj.get("ReferenceKeywordMatchType") is not None else None,
                        "ImpressionShare": obj.get("ImpressionShare") if obj.get("ImpressionShare") is not None else None,
                        "SearchQueryKPIs": [BroadMatchSearchQueryKPI.from_dict(_item) for _item in obj["SearchQueryKpis"]] if obj.get("SearchQueryKpis") is not None else None
        })
        return _obj
