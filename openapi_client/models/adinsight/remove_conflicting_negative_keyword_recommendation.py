...
class RemoveConflictingNegativeKeywordRecommendation(RecommendationBase):
    """
    ...
    type: Optional[StrictStr] = Field(default='RecommendationBase', alias="Type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AccountId": obj.get("AccountId") if obj.get("AccountId") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'RecommendationBase',
