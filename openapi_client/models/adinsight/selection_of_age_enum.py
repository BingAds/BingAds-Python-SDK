...
class SelectionOfAgeEnum(BaseModel):
    """
    SelectionOfAgeEnum
    """ # noqa: E501
    includes: Optional[List[Optional[AgeEnum]]] = Field(default=None, alias="Includes")
    excludes: Optional[List[Optional[AgeEnum]]] = Field(default=None, alias="Excludes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelectionOfAgeEnum from a dict"""
        if obj is None:
            return None
