...
class GetBidOpportunitiesRequest(BaseModel):
    """
    ...
    opportunity_type: Optional[BidOpportunityType] = Field(default=None, alias="OpportunityType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBidOpportunitiesRequest from a dict"""
        if obj is None:
            return None
