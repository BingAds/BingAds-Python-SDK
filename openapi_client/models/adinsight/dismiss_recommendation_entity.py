...
class DismissRecommendationEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["RecommendationId", "RecommendationType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DismissRecommendationEntity from a dict"""
        if obj is None:
            return None
