...
class BidOpportunityType(Flag):
    ...
    @classmethod
    def _validate(cls, value, handler) -> "BidOpportunityType":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid BidOpportunityType value: {value}")
        raise ValueError(f"Cannot convert {value} to BidOpportunityType")
