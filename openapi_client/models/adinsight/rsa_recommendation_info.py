...
class RSARecommendationInfo(RecommendationInfo):
    """
    ...
    type: Optional[StrictStr] = Field(default='RecommendationInfo', alias="Type")
    ad_id: Optional[StrictStr] = Field(default=None, alias="AdId")
    __properties: ClassVar[List[str]] = ["RecommendationId", "RecommendationHash", "Type", "AdId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RSARecommendationInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RSARecommendationInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "RecommendationId": obj.get("RecommendationId") if obj.get("RecommendationId") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'RecommendationInfo',
                        "AdId": obj.get("AdId") if obj.get("AdId") is not None else None
        })
        return _obj
