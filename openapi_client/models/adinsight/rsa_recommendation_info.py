...
class RSARecommendationInfo(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='RSARecommendationInfo', alias="Type")
    __properties: ClassVar[List[str]] = ["AdId", "RecommendationId", "RecommendationHash", "Type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AdId": obj.get("AdId") if obj.get("AdId") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'RSARecommendationInfo'
        })
        return _obj
