...
class CampaignBudgetRecommendation(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default='CampaignBudgetRecommendation', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CampaignBudgetRecommendation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignBudgetRecommendation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "RecommendedBudget": obj.get("RecommendedBudget") if obj.get("RecommendedBudget") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'CampaignBudgetRecommendation',
