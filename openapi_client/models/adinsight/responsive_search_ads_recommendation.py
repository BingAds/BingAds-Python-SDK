...
class ResponsiveSearchAdsRecommendation(BaseModel):
    """
    ResponsiveSearchAdsRecommendation
    """ # noqa: E501
    suggested_ad: Optional[SuggestedResponsiveSearchAd] = Field(default=None, alias="SuggestedAd")
    ...
    type: Optional[StrictStr] = Field(default='ResponsiveSearchAdsRecommendation', alias="Type")
    __properties: ClassVar[List[str]] = ["SuggestedAd", "AccountId", "CampaignId", "AdGroupId", "RecommendationType", "RecommendationId", "RecommendationHash", "CurrentClicks", "EstimatedIncreaseInClicks", "CurrentCost", "EstimatedIncreaseInCost", "CurrentImpressions", "EstimatedIncreaseInImpressions", "CurrentConversions", "EstimatedIncreaseInConversions", "Type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponsiveSearchAdsRecommendation from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of suggested_ad
        if self.suggested_ad:
            _dict['SuggestedAd'] = self.suggested_ad.to_dict()
        # set to None if suggested_ad (nullable) is None
        # and model_fields_set contains the field
        if self.suggested_ad is None and "suggested_ad" in self.model_fields_set:
            _dict['SuggestedAd'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponsiveSearchAdsRecommendation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "SuggestedAd": SuggestedResponsiveSearchAd.from_dict(obj["SuggestedAd"]) if obj.get("SuggestedAd") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'ResponsiveSearchAdsRecommendation'
        })
        return _obj
