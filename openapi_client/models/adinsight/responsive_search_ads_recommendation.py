...
class ResponsiveSearchAdsRecommendation(Recommendation):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CampaignId", "AdGroupId", "RecommendationType", "RecommendationId", "RecommendationHash", "CurrentClicks", "EstimatedIncreaseInClicks", "CurrentCost", "EstimatedIncreaseInCost", "CurrentImpressions", "EstimatedIncreaseInImpressions", "CurrentConversions", "EstimatedIncreaseInConversions", "Type", "SuggestedAd"]
