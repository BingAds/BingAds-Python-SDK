...
class EntityResult(BaseModel):
    ...
    categories: Optional[List[Optional[CategoryResult]]] = Field(default=None, alias="Categories")
    __properties: ClassVar[List[str]] = ["Id", "Type", "SubType", "Categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id") if obj.get("Id") is not None else None,
                        ...
                        "Categories": [CategoryResult.from_dict(_item) for _item in obj["Categories"]] if obj.get("Categories") is not None else None
        })
        return _obj
