...
class SimilarRemarketingList(Audience):
    ...
    __properties: ClassVar[List[str]] = ["Scope", "MembershipDuration", "SearchSize", "AudienceNetworkSize", "SupportedCampaignTypes", "CustomerShare", "Id", "Name", "Description", "Type", "ParentId", "ForwardCompatibilityMap", "SourceId"]
