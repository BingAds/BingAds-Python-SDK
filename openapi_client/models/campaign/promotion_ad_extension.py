...
class PromotionAdExtension(AdExtension):
    """
    ...
    __properties: ClassVar[List[str]] = ["Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "PromotionItem", "DiscountModifier", "PercentOff", "MoneyAmountOff", "PromotionCode", "OrdersOverAmount", "PromotionStartDate", "PromotionEndDate", "PromotionOccasion", "Language", "CurrencyCode", "FinalAppUrls", "FinalMobileUrls", "FinalUrls", "UrlCustomParameters", "TrackingUrlTemplate", "FinalUrlSuffix", "ForwardCompatibilityMap"]
