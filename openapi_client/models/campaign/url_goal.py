...
class UrlGoal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["UrlExpression", "UrlOperator", "Id", "Name", "Status", "Type", "Scope", "CountType", "Revenue", "ConversionWindowInMinutes", "TagId", "TrackingStatus", "ExcludeFromBidding", "ViewThroughConversionWindowInMinutes", "GoalCategory", "AttributionModelType", "IsEnhancedConversionsEnabled"]
