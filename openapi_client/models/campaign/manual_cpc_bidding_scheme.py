...
class ManualCpcBiddingScheme(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManualCpcBiddingScheme from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if manual_cpc (nullable) is None
        # and model_fields_set contains the field
        if self.manual_cpc is None and "manual_cpc" in self.model_fields_set:
            _dict['ManualCpc'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManualCpcBiddingScheme from a dict"""
        if obj is None:
            return None
