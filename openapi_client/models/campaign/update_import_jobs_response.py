...
class UpdateImportJobsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ImportJobIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateImportJobsResponse from a dict"""
        if obj is None:
            return None
