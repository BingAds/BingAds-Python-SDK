...
class GetAdsByIdsRequest(BaseModel):
    """
    GetAdsByIdsRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["AdGroupId", "AdIds", "AdTypes", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdsByIdsRequest from a dict"""
        if obj is None:
            return None
