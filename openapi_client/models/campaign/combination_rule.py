...
class CombinationRule(BaseModel):
    ...
    operator: Optional[LogicalOperator] = Field(default=None, alias="Operator")
    __properties: ClassVar[List[str]] = ["AudienceIds", "Operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CombinationRule from a dict"""
        if obj is None:
            return None
