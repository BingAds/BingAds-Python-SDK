...
class ImportOption(BaseModel):
    ...
    def __init__(self, **kwargs):
        if 'type' not in kwargs and 'Type' not in kwargs:
            ...
            type_mapping = [
                ...
                ('GoogleImportOption', 'GoogleImportOption'),
            ]
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        """Create an instance of ImportOption from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportOption from a dict"""
        if obj is None:
            return None
