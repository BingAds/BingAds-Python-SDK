...
class VideoAdExtension(AdExtension):
    """
    VideoAdExtension
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "Name", "DisplayText", "AlternativeText", "ActionText", "VideoId", "ThumbnailId", "ThumbnailUrl", "FinalMobileUrls", "FinalUrls", "UrlCustomParameters", "TrackingUrlTemplate", "FinalUrlSuffix", "FinalAppUrls", "ForwardCompatibilityMap"]
