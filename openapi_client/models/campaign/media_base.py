...
class MediaBase(Media):
    ...
    __properties: ClassVar[List[str]] = ["Id", "MediaType", "Type", "Text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MediaBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MediaBase from a dict"""
        if obj is None:
            return None
