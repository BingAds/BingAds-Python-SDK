...
class AssetGroupEditorialReasonCollection(BaseModel):
    """
    ...
    reasons: Optional[List[Optional[AssetGroupEditorialReason]]] = Field(default=None, alias="Reasons")
    appeal_status: Optional[AppealStatus] = Field(default=None, alias="AppealStatus")
    __properties: ClassVar[List[str]] = ["AssetGroupId", "CampaignId", "Reasons", "AppealStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetGroupEditorialReasonCollection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AssetGroupId": obj.get("AssetGroupId") if obj.get("AssetGroupId") is not None else None,
                        ...
                        "Reasons": [AssetGroupEditorialReason.from_dict(_item) for _item in obj["Reasons"]] if obj.get("Reasons") is not None else None,
