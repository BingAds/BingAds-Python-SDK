...
class AddNewCustomerAcquisitionGoalsResponse(BaseModel):
    """
    AddNewCustomerAcquisitionGoalsResponse
    """ # noqa: E501
    new_customer_acquisition_goal_ids: Optional[List[StrictStr]] = Field(default=None, alias="NewCustomerAcquisitionGoalIds")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["NewCustomerAcquisitionGoalIds", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if new_customer_acquisition_goal_ids (nullable) is None
        # and model_fields_set contains the field
        if self.new_customer_acquisition_goal_ids is None and "new_customer_acquisition_goal_ids" in self.model_fields_set:
            _dict['NewCustomerAcquisitionGoalIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddNewCustomerAcquisitionGoalsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "NewCustomerAcquisitionGoalIds": obj.get("NewCustomerAcquisitionGoalIds"),
