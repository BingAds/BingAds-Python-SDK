...
class GetVideosByIdsResponse(BaseModel):
    """
    GetVideosByIdsResponse
    """ # noqa: E501
    videos: Optional[List[Optional[Video]]] = Field(default=None, alias="Videos")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["Videos", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetVideosByIdsResponse from a dict"""
        if obj is None:
            return None
