...
class GetBMCStoresByCustomerIdRequest(BaseModel):
    """
    GetBMCStoresByCustomerIdRequest
    """ # noqa: E501
    return_additional_fields: Optional[BMCStoreAdditionalField] = Field(default=None, alias="ReturnAdditionalFields")
    __properties: ClassVar[List[str]] = ["ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBMCStoresByCustomerIdRequest from a dict"""
        if obj is None:
            return None
