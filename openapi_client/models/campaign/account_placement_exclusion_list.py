...
class AccountPlacementExclusionList(BaseModel):
    """
    AccountPlacementExclusionList
    """ # noqa: E501
    item_count: Optional[StrictInt] = Field(default=None, alias="ItemCount")
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    type: Optional[StrictStr] = Field(default='AccountPlacementExclusionList', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountPlacementExclusionList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountPlacementExclusionList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ItemCount": obj.get("ItemCount") if obj.get("ItemCount") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AccountPlacementExclusionList',
