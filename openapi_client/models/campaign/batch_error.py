...
class BatchError(BaseModel):
    ...
    def __init__(self, **kwargs):
        if 'type' not in kwargs and 'Type' not in kwargs:
            ...
            type_mapping = [
                ('BatchErrorBase', 'BatchError'),
                ('EditorialError', 'EditorialError'),
                ('BatchErrorBase', 'BatchErrorBase'),
            ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if type == "BatchError":
            ...
            return BatchErrorBase.from_dict(obj)
        
        if type == "EditorialError":
            from openapi_client.models.campaign.editorial_error import EditorialError
            return EditorialError.from_dict(obj)
        
        if type == "BatchErrorBase":
            from openapi_client.models.campaign.batch_error_base import BatchErrorBase
            return BatchErrorBase.from_dict(obj)
