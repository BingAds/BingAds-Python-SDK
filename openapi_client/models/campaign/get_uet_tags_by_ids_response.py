...
class GetUetTagsByIdsResponse(BaseModel):
    """
    GetUetTagsByIdsResponse
    """ # noqa: E501
    uet_tags: Optional[List[Optional[UetTag]]] = Field(default=None, alias="UetTags")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["UetTags", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in uet_tags (list)
        _items = []
        if self.uet_tags:
            for _item_uet_tags in self.uet_tags:
                if _item_uet_tags:
                    _items.append(_item_uet_tags.to_dict())
            _dict['UetTags'] = _items
        ...
        # set to None if uet_tags (nullable) is None
        # and model_fields_set contains the field
        if self.uet_tags is None and "uet_tags" in self.model_fields_set:
            _dict['UetTags'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUetTagsByIdsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "UetTags": [UetTag.from_dict(_item) for _item in obj["UetTags"]] if obj.get("UetTags") is not None else None,
