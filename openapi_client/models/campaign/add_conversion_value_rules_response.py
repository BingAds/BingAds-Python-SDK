...
class AddConversionValueRulesResponse(BaseModel):
    """
    AddConversionValueRulesResponse
    """ # noqa: E501
    conversion_value_rule_ids: Optional[List[StrictStr]] = Field(default=None, alias="ConversionValueRuleIds")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["ConversionValueRuleIds", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if conversion_value_rule_ids (nullable) is None
        # and model_fields_set contains the field
        if self.conversion_value_rule_ids is None and "conversion_value_rule_ids" in self.model_fields_set:
            _dict['ConversionValueRuleIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddConversionValueRulesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ConversionValueRuleIds": obj.get("ConversionValueRuleIds"),
