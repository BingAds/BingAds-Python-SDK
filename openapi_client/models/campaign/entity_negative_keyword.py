...
class EntityNegativeKeyword(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["EntityId", "EntityType", "NegativeKeywords"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityNegativeKeyword from a dict"""
        if obj is None:
            return None
