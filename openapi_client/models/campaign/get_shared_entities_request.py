...
class GetSharedEntitiesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["SharedEntityType", "SharedEntityScope"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSharedEntitiesRequest from a dict"""
        if obj is None:
            return None
