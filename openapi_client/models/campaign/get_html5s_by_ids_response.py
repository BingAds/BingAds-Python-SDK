...
class GetHTML5sByIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["HTML5Assets", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetHTML5sByIdsResponse from a dict"""
        if obj is None:
            return None
