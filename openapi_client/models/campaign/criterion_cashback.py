...
class CriterionCashback(BaseModel):
    ...
    def __init__(self, **kwargs):
        if 'type' not in kwargs and 'Type' not in kwargs:
            ...
            type_mapping = [
                ('CashbackAdjustment', 'CashbackAdjustment'),
            ]
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        """Create an instance of CriterionCashback from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CriterionCashback from a dict"""
        if obj is None:
            return None
