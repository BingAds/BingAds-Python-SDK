...
class CallToActionSetting(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallToActionSetting from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.automated_call_to_action_opt_out is None and "automated_call_to_action_opt_out" in self.model_fields_set:
            _dict['AutomatedCallToActionOptOut'] = None

        # set to None if call_to_action_opt_out (nullable) is None
        # and model_fields_set contains the field
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallToActionSetting from a dict"""
        if obj is None:
            return None
