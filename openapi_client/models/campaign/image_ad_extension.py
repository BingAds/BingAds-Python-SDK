...
class ImageAdExtension(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageAdExtension from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if layouts (nullable) is None
        # and model_fields_set contains the field
        if self.layouts is None and "layouts" in self.model_fields_set:
            _dict['Layouts'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageAdExtension from a dict"""
        if obj is None:
            return None
