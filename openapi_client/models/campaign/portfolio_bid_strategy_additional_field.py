...
class PortfolioBidStrategyAdditionalField(Flag):
    NONE = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "PortfolioBidStrategyAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid PortfolioBidStrategyAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to PortfolioBidStrategyAdditionalField")
