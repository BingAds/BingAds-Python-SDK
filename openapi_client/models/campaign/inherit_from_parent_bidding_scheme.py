...
class InheritFromParentBiddingScheme(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InheritFromParentBiddingScheme from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if inherited_bid_strategy_type (nullable) is None
        # and model_fields_set contains the field
        if self.inherited_bid_strategy_type is None and "inherited_bid_strategy_type" in self.model_fields_set:
            _dict['InheritedBidStrategyType'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InheritFromParentBiddingScheme from a dict"""
        if obj is None:
            return None
