...
class AssetGroupAdditionalField(Flag):
    NONE = auto()

    ASSETGROUPSEARCHTHEMES = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AssetGroupAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AssetGroupAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to AssetGroupAdditionalField")
