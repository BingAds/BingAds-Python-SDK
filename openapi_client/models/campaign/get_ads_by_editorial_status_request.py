...
class GetAdsByEditorialStatusRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdGroupId", "EditorialStatus", "AdTypes", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdsByEditorialStatusRequest from a dict"""
        if obj is None:
            return None
