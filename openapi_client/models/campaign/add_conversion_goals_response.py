...
class AddConversionGoalsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ConversionGoalIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddConversionGoalsResponse from a dict"""
        if obj is None:
            return None
