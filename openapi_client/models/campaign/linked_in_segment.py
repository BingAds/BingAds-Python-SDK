...
class LinkedInSegment(BaseModel):
    """
    LinkedInSegment
    """
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        """Create an instance of LinkedInSegment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkedInSegment from a dict"""
        if obj is None:
            return None
        ...
        if type == "CompanyName":
            ...
            return CompanyList.from_dict(obj)
