...
class AddLinkedInSegmentsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["LinkedInSegmentIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddLinkedInSegmentsResponse from a dict"""
        if obj is None:
            return None
