...
class GetMediaAssociationsResponse(BaseModel):
    """
    GetMediaAssociationsResponse
    """ # noqa: E501
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    media_associations: Optional[List[Optional[List[MediaAssociation]]]] = Field(default=None, alias="MediaAssociations")
    __properties: ClassVar[List[str]] = ["PartialErrors", "MediaAssociations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if media_associations (nullable) is None
        # and model_fields_set contains the field
        if self.media_associations is None and "media_associations" in self.model_fields_set:
            _dict['MediaAssociations'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMediaAssociationsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "PartialErrors": [BatchError.from_dict(_item) for _item in obj["PartialErrors"]] if obj.get("PartialErrors") is not None else None,
                        "MediaAssociations": obj.get("MediaAssociations")
        })
        return _obj
