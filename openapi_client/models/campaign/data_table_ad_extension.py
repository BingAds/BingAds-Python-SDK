...
class DataTableAdExtension(AdExtension):
    """
    ...
    __properties: ClassVar[List[str]] = ["Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "Name", "NameUrl", "ForwardCompatibilityMap"]
