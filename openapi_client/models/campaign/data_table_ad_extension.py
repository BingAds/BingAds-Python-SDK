...
class DataTableAdExtension(BaseModel):
    """
    DataTableAdExtension
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    name_url: Optional[StrictStr] = Field(default=None, alias="NameUrl")
    ...
    type: Optional[StrictStr] = Field(default='DataTableAdExtension', alias="Type")
    ...
    __properties: ClassVar[List[str]] = ["Name", "NameUrl", "Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "ForwardCompatibilityMap"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataTableAdExtension from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if name_url (nullable) is None
        # and model_fields_set contains the field
        if self.name_url is None and "name_url" in self.model_fields_set:
            _dict['NameUrl'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataTableAdExtension from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Name": obj.get("Name") if obj.get("Name") is not None else None,
                        "NameUrl": obj.get("NameUrl") if obj.get("NameUrl") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'DataTableAdExtension',
