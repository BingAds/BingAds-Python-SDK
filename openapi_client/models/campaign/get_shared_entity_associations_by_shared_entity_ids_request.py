...
class GetSharedEntityAssociationsBySharedEntityIdsRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if shared_entity_ids (nullable) is None
        # and model_fields_set contains the field
        if self.shared_entity_ids is None and "shared_entity_ids" in self.model_fields_set:
            _dict['SharedEntityIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSharedEntityAssociationsBySharedEntityIdsRequest from a dict"""
        if obj is None:
            return None
