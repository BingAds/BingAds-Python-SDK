...
class AddAssetGroupsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AssetGroupIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddAssetGroupsResponse from a dict"""
        if obj is None:
            return None
