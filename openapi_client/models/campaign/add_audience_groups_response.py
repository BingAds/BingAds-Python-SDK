...
class AddAudienceGroupsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AudienceGroupIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddAudienceGroupsResponse from a dict"""
        if obj is None:
            return None
