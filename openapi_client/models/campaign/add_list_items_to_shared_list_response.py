...
class AddListItemsToSharedListResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ListItemIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddListItemsToSharedListResponse from a dict"""
        if obj is None:
            return None
