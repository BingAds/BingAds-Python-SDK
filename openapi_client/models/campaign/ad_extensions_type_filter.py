...
class AdExtensionsTypeFilter(Flag):
    NONE = auto()

    LOCATIONADEXTENSION = auto()

    CALLADEXTENSION = auto()

    IMAGEADEXTENSION = auto()
    ...
    STRUCTUREDSNIPPETADEXTENSION = auto()

    PRICEADEXTENSION = auto()

    ACTIONADEXTENSION = auto()

    PROMOTIONADEXTENSION = auto()

    FILTERLINKADEXTENSION = auto()

    FLYERADEXTENSION = auto()

    VIDEOADEXTENSION = auto()

    DISCLAIMERADEXTENSION = auto()
    ...
    def _to_str(self) -> str:
        _NAME_MAPPING = {
            AdExtensionsTypeFilter.NONE: 'None',
            AdExtensionsTypeFilter.LOCATIONADEXTENSION: 'LocationAdExtension',
            ...
            AdExtensionsTypeFilter.PRICEADEXTENSION: 'PriceAdExtension',
            AdExtensionsTypeFilter.ACTIONADEXTENSION: 'ActionAdExtension',
            AdExtensionsTypeFilter.PROMOTIONADEXTENSION: 'PromotionAdExtension',
            AdExtensionsTypeFilter.FILTERLINKADEXTENSION: 'FilterLinkAdExtension',
            AdExtensionsTypeFilter.FLYERADEXTENSION: 'FlyerAdExtension',
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AdExtensionsTypeFilter":
