...
class GetConversionGoalsByTagIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ConversionGoals", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetConversionGoalsByTagIdsResponse from a dict"""
        if obj is None:
            return None
