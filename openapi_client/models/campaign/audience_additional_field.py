...
class AudienceAdditionalField(Flag):
    NONE = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AudienceAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AudienceAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to AudienceAdditionalField")
