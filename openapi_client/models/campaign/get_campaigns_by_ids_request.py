...
class GetCampaignsByIdsRequest(BaseModel):
    """
    ...
    return_additional_fields: Optional[CampaignAdditionalField] = Field(default=None, alias="ReturnAdditionalFields")
    __properties: ClassVar[List[str]] = ["AccountId", "CampaignIds", "CampaignType", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCampaignsByIdsRequest from a dict"""
        if obj is None:
            return None
