...
class ApplyAssetGroupListingGroupActionsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AssetGroupListingGroupIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplyAssetGroupListingGroupActionsResponse from a dict"""
        if obj is None:
            return None
