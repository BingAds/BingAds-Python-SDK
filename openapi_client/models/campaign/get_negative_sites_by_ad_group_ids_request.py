...
class GetNegativeSitesByAdGroupIdsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["CampaignId", "AdGroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNegativeSitesByAdGroupIdsRequest from a dict"""
        if obj is None:
            return None
