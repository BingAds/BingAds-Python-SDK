...
class BatchErrorBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["FieldPath", "ErrorCode", "Message", "Code", "Details", "Index", "Type", "ForwardCompatibilityMap"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchErrorBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchErrorBase from a dict"""
        if obj is None:
            return None
