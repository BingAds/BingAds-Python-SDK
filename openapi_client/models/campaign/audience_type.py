...
class AudienceType(Flag):
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AudienceType":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AudienceType value: {value}")
        raise ValueError(f"Cannot convert {value} to AudienceType")
