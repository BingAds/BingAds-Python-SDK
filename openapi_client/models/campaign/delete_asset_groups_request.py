...
class DeleteAssetGroupsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["CampaignId", "AssetGroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteAssetGroupsRequest from a dict"""
        if obj is None:
            return None
