...
class DisclaimerAdExtension(AdExtension):
    """
    ...
    __properties: ClassVar[List[str]] = ["Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "Name", "Title", "PopupText", "LineText", "DisclaimerLayout", "FinalUrlSuffix", "FinalUrls", "FinalMobileUrls", "FinalAppUrls", "UrlCustomParameters", "TrackingUrlTemplate", "ForwardCompatibilityMap"]
