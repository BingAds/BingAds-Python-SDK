...
class DisclaimerAdExtension(BaseModel):
    """
    DisclaimerAdExtension
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, alias="Name")
    title: Optional[StrictStr] = Field(default=None, alias="Title")
    popup_text: Optional[StrictStr] = Field(default=None, alias="PopupText")
    line_text: Optional[StrictStr] = Field(default=None, alias="LineText")
    disclaimer_layout: Optional[StrictStr] = Field(default=None, alias="DisclaimerLayout")
    ...
    type: Optional[StrictStr] = Field(default='DisclaimerAdExtension', alias="Type")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Title", "PopupText", "LineText", "DisclaimerLayout", "FinalUrlSuffix", "FinalUrls", "FinalMobileUrls", "FinalAppUrls", "UrlCustomParameters", "TrackingUrlTemplate", "Status", "Scheduling", "DevicePreference", "Id", "Type", "Version", "ForwardCompatibilityMap"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DisclaimerAdExtension from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if popup_text (nullable) is None
        # and model_fields_set contains the field
        if self.popup_text is None and "popup_text" in self.model_fields_set:
            _dict['PopupText'] = None

        # set to None if line_text (nullable) is None
        # and model_fields_set contains the field
        if self.line_text is None and "line_text" in self.model_fields_set:
            _dict['LineText'] = None

        # set to None if disclaimer_layout (nullable) is None
        # and model_fields_set contains the field
        if self.disclaimer_layout is None and "disclaimer_layout" in self.model_fields_set:
            _dict['DisclaimerLayout'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DisclaimerAdExtension from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Name": obj.get("Name") if obj.get("Name") is not None else None,
                        ...
                        "PopupText": obj.get("PopupText") if obj.get("PopupText") is not None else None,
                        "LineText": obj.get("LineText") if obj.get("LineText") is not None else None,
                        "DisclaimerLayout": obj.get("DisclaimerLayout") if obj.get("DisclaimerLayout") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'DisclaimerAdExtension',
