...
class GetClipchampTemplatesResponse(BaseModel):
    """
    GetClipchampTemplatesResponse
    """ # noqa: E501
    templates: Optional[List[Optional[ClipchampTemplateInfo]]] = Field(default=None, alias="Templates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetClipchampTemplatesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Templates": [ClipchampTemplateInfo.from_dict(_item) for _item in obj["Templates"]] if obj.get("Templates") is not None else None
        })
        return _obj
