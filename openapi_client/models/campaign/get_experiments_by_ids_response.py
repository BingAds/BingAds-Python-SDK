...
class GetExperimentsByIdsResponse(BaseModel):
    """
    GetExperimentsByIdsResponse
    """ # noqa: E501
    experiments: Optional[List[Optional[Experiment]]] = Field(default=None, alias="Experiments")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["Experiments", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetExperimentsByIdsResponse from a dict"""
        if obj is None:
            return None
