...
class CriterionBid(BaseModel):
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        """Create an instance of CriterionBid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CriterionBid from a dict"""
        if obj is None:
            return None
