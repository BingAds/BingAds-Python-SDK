...
class GetAdExtensionIdsByAccountIdResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdExtensionIdsByAccountIdResponse from a dict"""
        if obj is None:
            return None
