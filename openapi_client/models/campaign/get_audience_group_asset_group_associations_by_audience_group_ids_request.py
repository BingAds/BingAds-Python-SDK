...
class GetAudienceGroupAssetGroupAssociationsByAudienceGroupIdsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AudienceGroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAudienceGroupAssetGroupAssociationsByAudienceGroupIdsRequest from a dict"""
        if obj is None:
            return None
