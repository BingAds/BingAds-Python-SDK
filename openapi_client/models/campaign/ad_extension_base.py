...
class AdExtensionBase(AdExtension):
    """
    AdExtensionBase
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Status", "Scheduling", "DevicePreference", "Id", "Type", "Version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdExtensionBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdExtensionBase from a dict"""
        if obj is None:
            return None
