...
class GetKeywordsByIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Keywords", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetKeywordsByIdsResponse from a dict"""
        if obj is None:
            return None
