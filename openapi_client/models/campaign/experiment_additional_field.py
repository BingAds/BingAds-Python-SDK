...
class ExperimentAdditionalField(Flag):
    NONE = auto()

    EXPERIMENTSUBTYPE = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "ExperimentAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid ExperimentAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to ExperimentAdditionalField")
