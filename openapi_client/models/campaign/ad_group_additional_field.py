...
class AdGroupAdditionalField(Flag):
    NONE = auto()
    ...
    USEOPTIMIZEDTARGETING = auto()

    FREQUENCYCAPSETTINGS = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AdGroupAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AdGroupAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to AdGroupAdditionalField")
