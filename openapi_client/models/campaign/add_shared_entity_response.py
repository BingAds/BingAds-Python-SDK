...
class AddSharedEntityResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["SharedEntityId", "ListItemIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddSharedEntityResponse from a dict"""
        if obj is None:
            return None
