...
class AddDataExclusionsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DataExclusionIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddDataExclusionsResponse from a dict"""
        if obj is None:
            return None
