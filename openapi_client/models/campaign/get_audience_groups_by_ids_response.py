...
class GetAudienceGroupsByIdsResponse(BaseModel):
    """
    GetAudienceGroupsByIdsResponse
    """ # noqa: E501
    audience_groups: Optional[List[Optional[AudienceGroup]]] = Field(default=None, alias="AudienceGroups")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["AudienceGroups", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.audience_groups:
            for _item_audience_groups in self.audience_groups:
                if _item_audience_groups:
                    _items.append(_item_audience_groups.to_dict())
        ...
        # set to None if audience_groups (nullable) is None
        # and model_fields_set contains the field
        if self.audience_groups is None and "audience_groups" in self.model_fields_set:
            _dict['AudienceGroups'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAudienceGroupsByIdsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AudienceGroups": [AudienceGroup.from_dict(_item) for _item in obj["AudienceGroups"]] if obj.get("AudienceGroups") is not None else None,
