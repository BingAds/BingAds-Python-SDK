...
class GetConversionValueRulesByAccountIdRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "Lcid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetConversionValueRulesByAccountIdRequest from a dict"""
        if obj is None:
            return None
