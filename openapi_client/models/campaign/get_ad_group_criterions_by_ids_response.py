...
class GetAdGroupCriterionsByIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdGroupCriterions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdGroupCriterionsByIdsResponse from a dict"""
        if obj is None:
            return None
