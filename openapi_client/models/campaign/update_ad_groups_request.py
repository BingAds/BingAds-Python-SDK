...
class UpdateAdGroupsRequest(BaseModel):
    """
    ...
    update_audience_ads_bid_adjustment: Optional[StrictBool] = Field(default=None, alias="UpdateAudienceAdsBidAdjustment")
    return_inherited_bid_strategy_types: Optional[StrictBool] = Field(default=None, alias="ReturnInheritedBidStrategyTypes")
    __properties: ClassVar[List[str]] = ["CampaignId", "AdGroups", "UpdateAudienceAdsBidAdjustment", "ReturnInheritedBidStrategyTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if update_audience_ads_bid_adjustment (nullable) is None
        # and model_fields_set contains the field
        if self.update_audience_ads_bid_adjustment is None and "update_audience_ads_bid_adjustment" in self.model_fields_set:
            _dict['UpdateAudienceAdsBidAdjustment'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAdGroupsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "CampaignId": obj.get("CampaignId") if obj.get("CampaignId") is not None else None,
                        ...
                        "UpdateAudienceAdsBidAdjustment": obj.get("UpdateAudienceAdsBidAdjustment") if obj.get("UpdateAudienceAdsBidAdjustment") is not None else None,
