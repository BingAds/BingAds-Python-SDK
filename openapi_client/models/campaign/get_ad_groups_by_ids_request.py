...
class GetAdGroupsByIdsRequest(BaseModel):
    """
    ...
    return_additional_fields: Optional[AdGroupAdditionalField] = Field(default=None, alias="ReturnAdditionalFields")
    __properties: ClassVar[List[str]] = ["CampaignId", "AdGroupIds", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdGroupsByIdsRequest from a dict"""
        if obj is None:
            return None
