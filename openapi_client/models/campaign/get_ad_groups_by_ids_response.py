...
class GetAdGroupsByIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdGroups", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdGroupsByIdsResponse from a dict"""
        if obj is None:
            return None
