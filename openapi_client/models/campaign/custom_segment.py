...
class CustomSegment(Audience):
    ...
    custom_segment_catalog_list: Optional[List[Optional[CustomSegmentCatalog]]] = Field(default=None, alias="CustomSegmentCatalogList")
    editorial_status: Optional[CustomSegmentEditorialStatus] = Field(default=None, alias="EditorialStatus")
    __properties: ClassVar[List[str]] = ["Scope", "MembershipDuration", "SearchSize", "AudienceNetworkSize", "SupportedCampaignTypes", "CustomerShare", "Id", "Name", "Description", "Type", "ParentId", "ForwardCompatibilityMap", "CustomSegmentCatalogList", "EditorialStatus"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomSegment from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in custom_segment_catalog_list (list)
        _items = []
        if self.custom_segment_catalog_list:
            for _item_custom_segment_catalog_list in self.custom_segment_catalog_list:
                if _item_custom_segment_catalog_list:
                    _items.append(_item_custom_segment_catalog_list.to_dict())
            _dict['CustomSegmentCatalogList'] = _items
        ...
        # set to None if custom_segment_catalog_list (nullable) is None
        # and model_fields_set contains the field
        if self.custom_segment_catalog_list is None and "custom_segment_catalog_list" in self.model_fields_set:
            _dict['CustomSegmentCatalogList'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomSegment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": obj.get("Scope") if obj.get("Scope") is not None else None,
                        ...
                        "CustomSegmentCatalogList": [CustomSegmentCatalog.from_dict(_item) for _item in obj["CustomSegmentCatalogList"]] if obj.get("CustomSegmentCatalogList") is not None else None,
