...
class AddListItemsToSharedListRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ListItems", "SharedList", "SharedEntityScope"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddListItemsToSharedListRequest from a dict"""
        if obj is None:
            return None
