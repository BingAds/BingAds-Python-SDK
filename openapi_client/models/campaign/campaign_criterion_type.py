...
class CampaignCriterionType(Flag):
    PRODUCTSCOPE = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "CampaignCriterionType":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid CampaignCriterionType value: {value}")
        raise ValueError(f"Cannot convert {value} to CampaignCriterionType")
