...
class GetNegativeSitesByCampaignIdsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CampaignIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNegativeSitesByCampaignIdsRequest from a dict"""
        if obj is None:
            return None
