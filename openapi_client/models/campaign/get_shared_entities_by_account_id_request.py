...
class GetSharedEntitiesByAccountIdRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSharedEntitiesByAccountIdRequest from a dict"""
        if obj is None:
            return None
