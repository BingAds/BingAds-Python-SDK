...
class PageVisitorsRule(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageVisitorsRule from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if normal_form (nullable) is None
        # and model_fields_set contains the field
        if self.normal_form is None and "normal_form" in self.model_fields_set:
            _dict['NormalForm'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageVisitorsRule from a dict"""
        if obj is None:
            return None
