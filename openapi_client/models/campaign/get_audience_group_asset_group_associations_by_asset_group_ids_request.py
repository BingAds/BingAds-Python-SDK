...
class GetAudienceGroupAssetGroupAssociationsByAssetGroupIdsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AssetGroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAudienceGroupAssetGroupAssociationsByAssetGroupIdsRequest from a dict"""
        if obj is None:
            return None
