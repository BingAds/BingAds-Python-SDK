...
class ProductAudienceType(Flag):
    GENERALVISITORS = auto()

    PRODUCTSEARCHERS = auto()

    PRODUCTVIEWERS = auto()

    SHOPPINGCARTABANDONERS = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "ProductAudienceType":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid ProductAudienceType value: {value}")
        raise ValueError(f"Cannot convert {value} to ProductAudienceType")
