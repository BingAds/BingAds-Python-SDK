...
class DeleteAdExtensionsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "AdExtensionIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteAdExtensionsRequest from a dict"""
        if obj is None:
            return None
