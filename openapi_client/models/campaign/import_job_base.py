...
class ImportJobBase(ImportJob):
    ...
    __properties: ClassVar[List[str]] = ["Name", "Id", "Type", "Status", "NotificationType", "CreatedByUserId", "CreatedByUserName", "Frequency", "LastRunTimeInUTC", "CreatedDateTimeInUTC", "ImportOption", "NotificationEmail"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportJobBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportJobBase from a dict"""
        if obj is None:
            return None
