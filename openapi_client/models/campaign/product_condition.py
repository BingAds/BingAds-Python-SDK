...
class ProductCondition(BaseModel):
    ...
    attribute: Optional[StrictStr] = Field(default=None, alias="Attribute")
    operator: Optional[StrictStr] = Field(default=None, alias="Operator")
    __properties: ClassVar[List[str]] = ["Operand", "Attribute", "Operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductCondition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Operand": obj.get("Operand") if obj.get("Operand") is not None else None,
                        "Attribute": obj.get("Attribute") if obj.get("Attribute") is not None else None,
