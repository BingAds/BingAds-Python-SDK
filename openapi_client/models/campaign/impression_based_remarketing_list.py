...
class ImpressionBasedRemarketingList(Audience):
    """
    ...
    __properties: ClassVar[List[str]] = ["Scope", "MembershipDuration", "SearchSize", "AudienceNetworkSize", "SupportedCampaignTypes", "CustomerShare", "Id", "Name", "Description", "Type", "ParentId", "ForwardCompatibilityMap", "EntityType", "CampaignId", "AdGroupId", "CampaignIds", "AdGroupIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImpressionBasedRemarketingList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImpressionBasedRemarketingList from a dict"""
        if obj is None:
            return None
