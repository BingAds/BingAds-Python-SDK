...
class GetCampaignsByAccountIdRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CampaignType", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCampaignsByAccountIdRequest from a dict"""
        if obj is None:
            return None
