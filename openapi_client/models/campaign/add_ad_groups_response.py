...
class AddAdGroupsResponse(BaseModel):
    """
    AddAdGroupsResponse
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["AdGroupIds", "PartialErrors", "InheritedBidStrategyTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddAdGroupsResponse from a dict"""
        if obj is None:
            return None
