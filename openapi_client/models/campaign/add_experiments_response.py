...
class AddExperimentsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ExperimentIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddExperimentsResponse from a dict"""
        if obj is None:
            return None
