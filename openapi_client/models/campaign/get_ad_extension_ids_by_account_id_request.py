...
class GetAdExtensionIdsByAccountIdRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "AssociationType", "AdExtensionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdExtensionIdsByAccountIdRequest from a dict"""
        if obj is None:
            return None
