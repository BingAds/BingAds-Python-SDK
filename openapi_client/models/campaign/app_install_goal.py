...
class AppInstallGoal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["AppPlatform", "AppStoreId", "Id", "Name", "Status", "Type", "Scope", "CountType", "Revenue", "ConversionWindowInMinutes", "TagId", "TrackingStatus", "ExcludeFromBidding", "ViewThroughConversionWindowInMinutes", "GoalCategory", "AttributionModelType", "IsEnhancedConversionsEnabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppInstallGoal from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppInstallGoal from a dict"""
        if obj is None:
            return None
