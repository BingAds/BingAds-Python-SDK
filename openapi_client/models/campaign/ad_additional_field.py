...
class AdAdditionalField(Flag):
    NONE = auto()

    IMPRESSIONTRACKINGURLS = auto()

    VIDEOS = auto()

    LONGHEADLINES = auto()

    IMAGETARGETDIMENSION = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AdAdditionalField":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AdAdditionalField value: {value}")
        raise ValueError(f"Cannot convert {value} to AdAdditionalField")
