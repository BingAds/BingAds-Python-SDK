...
class SitelinkAdExtension(BaseModel):
    ...
    description2: Optional[StrictStr] = Field(default=None, alias="Description2")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SitelinkAdExtension from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SitelinkAdExtension from a dict"""
        if obj is None:
            return None
