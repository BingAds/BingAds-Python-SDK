...
class GetUetTagAuthKeyResponse(BaseModel):
    """
    GetUetTagAuthKeyResponse
    """ # noqa: E501
    uet_tag_auth_key: Optional[StrictStr] = Field(default=None, alias="UetTagAuthKey")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["UetTagAuthKey", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if uet_tag_auth_key (nullable) is None
        # and model_fields_set contains the field
        if self.uet_tag_auth_key is None and "uet_tag_auth_key" in self.model_fields_set:
            _dict['UetTagAuthKey'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUetTagAuthKeyResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "UetTagAuthKey": obj.get("UetTagAuthKey") if obj.get("UetTagAuthKey") is not None else None,
