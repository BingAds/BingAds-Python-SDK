...
class BatchErrorCollectionBase(BatchErrorCollection):
    """
    ...
    __properties: ClassVar[List[str]] = ["ForwardCompatibilityMap", "FieldPath", "BatchErrors", "Message", "ErrorCode", "Code", "Details", "Index", "Type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchErrorCollectionBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchErrorCollectionBase from a dict"""
        if obj is None:
            return None
