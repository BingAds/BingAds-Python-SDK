...
class CustomLinkedInCriterion(Criterion):
    """
    CustomLinkedInCriterion
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Type", "ProfileId", "Profile", "ProfileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomLinkedInCriterion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomLinkedInCriterion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Type": obj.get("Type") if obj.get("Type") is not None else None,
                        ...
                        "Profile": obj.get("Profile") if obj.get("Profile") is not None else None,
