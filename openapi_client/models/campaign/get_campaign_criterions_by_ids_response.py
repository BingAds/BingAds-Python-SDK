...
class GetCampaignCriterionsByIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["CampaignCriterions", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCampaignCriterionsByIdsResponse from a dict"""
        if obj is None:
            return None
