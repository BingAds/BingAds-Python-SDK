...
class CustomAudience(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Custom', alias="Type")
    ...
    __properties: ClassVar[List[str]] = ["Id", "Name", "Description", "Scope", "ParentId", "MembershipDuration", "Type", "SearchSize", "AudienceNetworkSize", "SupportedCampaignTypes", "CustomerShare", "ForwardCompatibilityMap"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomAudience from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomAudience from a dict"""
        if obj is None:
            return None
