...
class GetAdExtensionsAssociationsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "EntityIds", "AdExtensionType", "AssociationType", "ReturnAdditionalFields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdExtensionsAssociationsRequest from a dict"""
        if obj is None:
            return None
