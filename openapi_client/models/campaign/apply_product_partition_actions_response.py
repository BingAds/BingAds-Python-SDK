...
class ApplyProductPartitionActionsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdGroupCriterionIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplyProductPartitionActionsResponse from a dict"""
        if obj is None:
            return None
