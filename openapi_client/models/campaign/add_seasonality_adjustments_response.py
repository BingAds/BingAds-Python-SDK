...
class AddSeasonalityAdjustmentsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["SeasonalityAdjustmentIds", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddSeasonalityAdjustmentsResponse from a dict"""
        if obj is None:
            return None
