...
class MediaEnabledEntityFilter(Flag):
    NONE = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "MediaEnabledEntityFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid MediaEnabledEntityFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to MediaEnabledEntityFilter")
