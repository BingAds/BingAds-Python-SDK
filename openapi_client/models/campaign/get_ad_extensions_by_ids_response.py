...
class GetAdExtensionsByIdsResponse(BaseModel):
    """
    GetAdExtensionsByIdsResponse
    """ # noqa: E501
    ad_extensions: Optional[List[Optional[AdExtension]]] = Field(default=None, alias="AdExtensions")
    partial_errors: Optional[List[Optional[BatchError]]] = Field(default=None, alias="PartialErrors")
    __properties: ClassVar[List[str]] = ["AdExtensions", "PartialErrors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ad_extensions (list)
        _items = []
        if self.ad_extensions:
            for _item_ad_extensions in self.ad_extensions:
                if _item_ad_extensions:
                    _items.append(_item_ad_extensions.to_dict())
            _dict['AdExtensions'] = _items
        ...
        # set to None if ad_extensions (nullable) is None
        # and model_fields_set contains the field
        if self.ad_extensions is None and "ad_extensions" in self.model_fields_set:
            _dict['AdExtensions'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAdExtensionsByIdsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AdExtensions": [AdExtension.from_dict(_item) for _item in obj["AdExtensions"]] if obj.get("AdExtensions") is not None else None,
