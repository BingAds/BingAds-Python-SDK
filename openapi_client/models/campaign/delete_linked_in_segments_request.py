...
class DeleteLinkedInSegmentsRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteLinkedInSegmentsRequest from a dict"""
        if obj is None:
            return None
