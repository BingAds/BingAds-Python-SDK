...
class Frequency(BaseModel):
    ...
    cron: Optional[StrictStr] = Field(default=None, alias="Cron")
    __properties: ClassVar[List[str]] = ["Type", "TimeZone", "Cron"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Type": obj.get("Type") if obj.get("Type") is not None else None,
                        ...
                        "Cron": obj.get("Cron") if obj.get("Cron") is not None else None
        })
        return _obj
