...
class GetSharedEntityAssociationsBySharedEntityIdsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Associations", "PartialErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSharedEntityAssociationsBySharedEntityIdsResponse from a dict"""
        if obj is None:
            return None
