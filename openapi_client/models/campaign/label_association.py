...
class LabelAssociation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["LabelId", "EntityId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LabelAssociation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "LabelId": obj.get("LabelId") if obj.get("LabelId") is not None else None,
