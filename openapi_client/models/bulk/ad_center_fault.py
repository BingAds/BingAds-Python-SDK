...
class AdCenterFault(ApplicationFault):
    """
    AdCenterFault
    """ # noqa: E501
    ...
    type: Optional[StrictStr] = Field(default='AdCenterFault', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdCenterFault from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdCenterFault from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "TrackingId": obj.get("TrackingId") if obj.get("TrackingId") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AdCenterFault'
        })
        return _obj
