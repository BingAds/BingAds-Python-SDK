...
class EditorialApiFaultDetail(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditorialApiFaultDetail from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in editorial_errors (list)
        _items = []
        if self.editorial_errors:
            for _item_editorial_errors in self.editorial_errors:
                if _item_editorial_errors:
                    _items.append(_item_editorial_errors.to_dict())
            _dict['EditorialErrors'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditorialApiFaultDetail from a dict"""
        if obj is None:
            return None
