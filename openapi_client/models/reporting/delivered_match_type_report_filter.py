...
class DeliveredMatchTypeReportFilter(Flag):
    EXACT = auto()
    ...
    def _to_str(self) -> str:
        _NAME_MAPPING = {
            DeliveredMatchTypeReportFilter.EXACT: 'Exact',
            DeliveredMatchTypeReportFilter.PHRASE: 'Phrase',
    ...
    @classmethod
    def _validate(cls, value, handler) -> "DeliveredMatchTypeReportFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid DeliveredMatchTypeReportFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to DeliveredMatchTypeReportFilter")
