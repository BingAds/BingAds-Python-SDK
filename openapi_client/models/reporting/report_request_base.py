...
class ReportRequestBase(ReportRequest):
    """
    ReportRequestBase
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["ReportName", "Format", "ReturnOnlyCompleteData", "ExcludeReportHeader", "ExcludeReportFooter", "ExcludeColumnHeaders", "FormatVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportRequestBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportRequestBase from a dict"""
        if obj is None:
            return None
