...
class GoalsAndFunnelsReportRequest(BaseModel):
    """
    GoalsAndFunnelsReportRequest
    """ # noqa: E501
    scope: Optional[AccountThroughAdGroupReportScope] = Field(default=None, alias="Scope")
    filter: Optional[GoalsAndFunnelsReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[GoalsAndFunnelsReportColumn]]] = Field(default=None, alias="Columns")
    ...
    type: Optional[StrictStr] = Field(default='GoalsAndFunnelsReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoalsAndFunnelsReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoalsAndFunnelsReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": AccountThroughAdGroupReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": GoalsAndFunnelsReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'GoalsAndFunnelsReportRequest'
        })
        return _obj
