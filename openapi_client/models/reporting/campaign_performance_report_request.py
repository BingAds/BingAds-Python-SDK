...
class CampaignPerformanceReportRequest(BaseModel):
    """
    CampaignPerformanceReportRequest
    """ # noqa: E501
    scope: Optional[AccountThroughCampaignReportScope] = Field(default=None, alias="Scope")
    filter: Optional[CampaignPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[CampaignPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    ...
    type: Optional[StrictStr] = Field(default='CampaignPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CampaignPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": AccountThroughCampaignReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": CampaignPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'CampaignPerformanceReportRequest'
        })
        return _obj
