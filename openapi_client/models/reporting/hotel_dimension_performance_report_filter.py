...
class HotelDimensionPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DeviceType", "AccountStatus", "CampaignStatus", "AdGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HotelDimensionPerformanceReportFilter from a dict"""
        if obj is None:
            return None
