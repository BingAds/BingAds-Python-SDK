...
class AssetGroupReportScope(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CampaignId", "AssetGroupId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetGroupReportScope from a dict"""
        if obj is None:
            return None
