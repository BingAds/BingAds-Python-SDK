...
class DSACategoryPerformanceReportRequest(ReportRequest):
    """
    ...
    filter: Optional[DSACategoryPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[DSACategoryPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='DSACategoryPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DSACategoryPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSACategoryPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": DSACategoryPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'DSACategoryPerformanceReportRequest'
        })
        return _obj
