...
class ProductNegativeKeywordConflictReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountStatus", "CampaignStatus", "AdGroupStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductNegativeKeywordConflictReportFilter from a dict"""
        if obj is None:
            return None
