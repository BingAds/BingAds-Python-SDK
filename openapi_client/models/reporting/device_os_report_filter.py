...
class DeviceOSReportFilter(Flag):
    OTHER = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "DeviceOSReportFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid DeviceOSReportFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to DeviceOSReportFilter")
