...
class AdExtensionDetailReportRequest(ReportRequest):
    """
    ...
    columns: Optional[List[Optional[AdExtensionDetailReportColumn]]] = Field(default=None, alias="Columns")
    filter: Optional[AdExtensionDetailReportFilter] = Field(default=None, alias="Filter")
    type: Optional[StrictStr] = Field(default='AdExtensionDetailReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdExtensionDetailReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdExtensionDetailReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": AdExtensionDetailReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AdExtensionDetailReportRequest'
        })
        return _obj
