...
class AppsPerformanceReportFilter(BaseModel):
    """
    AppsPerformanceReportFilter
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["AccountStatus", "CampaignStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppsPerformanceReportFilter from a dict"""
        if obj is None:
            return None
