...
class GeographicPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "CountryCode", "Language", "AccountStatus", "CampaignStatus", "AdGroupStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GeographicPerformanceReportFilter from a dict"""
        if obj is None:
            return None
