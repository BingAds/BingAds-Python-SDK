...
class NegativeKeywordConflictReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountStatus", "CampaignStatus", "AdGroupStatus", "KeywordStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NegativeKeywordConflictReportFilter from a dict"""
        if obj is None:
            return None
