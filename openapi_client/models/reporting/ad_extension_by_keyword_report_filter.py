...
class AdExtensionByKeywordReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DeviceType", "DeviceOS", "AccountStatus", "CampaignStatus", "AdGroupStatus", "KeywordStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdExtensionByKeywordReportFilter from a dict"""
        if obj is None:
            return None
