...
class AdPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "AdType", "DeviceType", "Language", "AccountStatus", "CampaignStatus", "AdGroupStatus", "AdStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdPerformanceReportFilter from a dict"""
        if obj is None:
            return None
