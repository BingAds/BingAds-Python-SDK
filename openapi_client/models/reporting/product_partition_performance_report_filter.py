...
class ProductPartitionPerformanceReportFilter(BaseModel):
    """
    ...
    campaign_type: Optional[CampaignTypeReportFilter] = Field(default=None, alias="CampaignType")
    ...
    __properties: ClassVar[List[str]] = ["DeviceType", "Language", "AccountStatus", "CampaignStatus", "CampaignType", "AdGroupStatus", "AdStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductPartitionPerformanceReportFilter from a dict"""
        if obj is None:
            return None
