...
class ConversionPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Keywords", "DeviceType", "AdDistribution", "AccountStatus", "CampaignStatus", "AdGroupStatus", "KeywordStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConversionPerformanceReportFilter from a dict"""
        if obj is None:
            return None
