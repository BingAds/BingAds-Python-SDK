...
class GoalsAndFunnelsReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["GoalIds", "AdDistribution", "DeviceType", "DeviceOS", "AccountStatus", "CampaignStatus", "AdGroupStatus", "KeywordStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoalsAndFunnelsReportFilter from a dict"""
        if obj is None:
            return None
