...
class AccountPerformanceReportRequest(BaseModel):
    """
    AccountPerformanceReportRequest
    """ # noqa: E501
    scope: Optional[AccountReportScope] = Field(default=None, alias="Scope")
    filter: Optional[AccountPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[AccountPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    ...
    type: Optional[StrictStr] = Field(default='AccountPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": AccountReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": AccountPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AccountPerformanceReportRequest'
        })
        return _obj
