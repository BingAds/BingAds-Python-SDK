...
class CampaignPerformanceReportFilter(BaseModel):
    """
    ...
    status: Optional[CampaignStatusReportFilter] = Field(default=None, alias="Status")
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "Status", "DeviceType", "DeviceOS", "AccountStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignPerformanceReportFilter from a dict"""
        if obj is None:
            return None
