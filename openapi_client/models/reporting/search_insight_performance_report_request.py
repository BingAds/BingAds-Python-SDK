...
class SearchInsightPerformanceReportRequest(ReportRequest):
    """
    ...
    scope: Optional[AccountThroughCampaignReportScope] = Field(default=None, alias="Scope")
    filter: Optional[SearchInsightPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[SearchInsightPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='SearchInsightPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchInsightPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchInsightPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Scope": AccountThroughCampaignReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": SearchInsightPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'SearchInsightPerformanceReportRequest'
        })
        return _obj
