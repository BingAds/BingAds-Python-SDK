...
class ChangeTypeReportFilter(Flag):
    ADDED = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "ChangeTypeReportFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid ChangeTypeReportFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to ChangeTypeReportFilter")
