...
class MMMPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AccountStatus", "AdDistribution", "AdGroupStatus", "AssetGroupStatus", "CampaignStatus", "CountryCode", "Language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MMMPerformanceReportFilter from a dict"""
        if obj is None:
            return None
