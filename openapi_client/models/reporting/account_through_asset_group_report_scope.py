...
class AccountThroughAssetGroupReportScope(BaseModel):
    """
    ...
    asset_groups: Optional[List[Optional[AssetGroupReportScope]]] = Field(default=None, alias="AssetGroups")
    __properties: ClassVar[List[str]] = ["AccountIds", "Campaigns", "AssetGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountThroughAssetGroupReportScope from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "AccountIds": obj.get("AccountIds"),
                        ...
                        "AssetGroups": [AssetGroupReportScope.from_dict(_item) for _item in obj["AssetGroups"]] if obj.get("AssetGroups") is not None else None
        })
        return _obj
