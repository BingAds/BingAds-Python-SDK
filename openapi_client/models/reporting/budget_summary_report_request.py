...
class BudgetSummaryReportRequest(BaseModel):
    """
    ...
    columns: Optional[List[Optional[BudgetSummaryReportColumn]]] = Field(default=None, alias="Columns")
    ...
    type: Optional[StrictStr] = Field(default='BudgetSummaryReportRequest', alias="Type")
    __properties: ClassVar[List[str]] = ["Scope", "Time", "Columns", "ReportName", "Format", "ReturnOnlyCompleteData", "ExcludeReportHeader", "ExcludeReportFooter", "ExcludeColumnHeaders", "FormatVersion", "Type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BudgetSummaryReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BudgetSummaryReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": AccountThroughCampaignReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'BudgetSummaryReportRequest'
        })
        return _obj
