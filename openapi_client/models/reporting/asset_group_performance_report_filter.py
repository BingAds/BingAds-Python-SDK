...
class AssetGroupPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AssetGroupStatus", "AccountStatus", "CampaignStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetGroupPerformanceReportFilter from a dict"""
        if obj is None:
            return None
