...
class ShareOfVoiceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "BidMatchType", "DeliveredMatchType", "Keywords", "Language", "DeviceType", "AccountStatus", "CampaignStatus", "AdGroupStatus", "KeywordStatus", "BidStrategyType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShareOfVoiceReportFilter from a dict"""
        if obj is None:
            return None
