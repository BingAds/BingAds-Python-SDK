...
class ChangeEntityReportFilter(Flag):
    ACCOUNT = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "ChangeEntityReportFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid ChangeEntityReportFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to ChangeEntityReportFilter")
