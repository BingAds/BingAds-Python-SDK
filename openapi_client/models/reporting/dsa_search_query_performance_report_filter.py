...
class DSASearchQueryPerformanceReportFilter(BaseModel):
    """
    ...
    feed_url: Optional[StrictBool] = Field(default=None, alias="FeedUrl")
    __properties: ClassVar[List[str]] = ["SearchQueries", "AccountStatus", "CampaignStatus", "AdGroupStatus", "AdStatus", "Language", "ExcludeZeroClicks", "FeedUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSASearchQueryPerformanceReportFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "SearchQueries": obj.get("SearchQueries"),
                        ...
                        "FeedUrl": obj.get("FeedUrl") if obj.get("FeedUrl") is not None else None
        })
        return _obj
