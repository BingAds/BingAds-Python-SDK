...
class AdExtensionByAdReportRequest(ReportRequest):
    """
    ...
    columns: Optional[List[Optional[AdExtensionByAdReportColumn]]] = Field(default=None, alias="Columns")
    filter: Optional[AdExtensionByAdReportFilter] = Field(default=None, alias="Filter")
    type: Optional[StrictStr] = Field(default='AdExtensionByAdReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdExtensionByAdReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdExtensionByAdReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": AdExtensionByAdReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AdExtensionByAdReportRequest'
        })
        return _obj
