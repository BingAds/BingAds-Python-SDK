...
class AdExtensionDetailReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DeviceType", "DeviceOS", "AccountStatus", "CampaignStatus", "AdGroupStatus", "AdStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdExtensionDetailReportFilter from a dict"""
        if obj is None:
            return None
