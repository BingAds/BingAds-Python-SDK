...
class SearchInsightPerformanceReportFilter(BaseModel):
    """
    SearchInsightPerformanceReportFilter
    """ # noqa: E501
    search_category: Optional[List[StrictStr]] = Field(default=None, alias="SearchCategory")
    ...
    __properties: ClassVar[List[str]] = ["SearchCategory", "SearchQueries", "CampaignStatus", "AccountStatus", "AdGroupStatus", "AssetGroupStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if search_category (nullable) is None
        # and model_fields_set contains the field
        if self.search_category is None and "search_category" in self.model_fields_set:
            _dict['SearchCategory'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchInsightPerformanceReportFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "SearchCategory": obj.get("SearchCategory"),
