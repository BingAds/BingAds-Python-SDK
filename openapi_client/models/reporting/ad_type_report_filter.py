...
class AdTypeReportFilter(Flag):
    ...
    DYNAMICSEARCHAD = auto()

    EXPANDEDTEXT = auto()

    RESPONSIVEAD = auto()

    RESPONSIVESEARCHAD = auto()
    ...
    @classmethod
    def _validate(cls, value, handler) -> "AdTypeReportFilter":
        ...
        if isinstance(value, str):
            ...
            if len(types) > 1:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid AdTypeReportFilter value: {value}")
        raise ValueError(f"Cannot convert {value} to AdTypeReportFilter")
