...
class ProductPartitionUnitPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DeviceType", "Language", "AccountStatus", "CampaignStatus", "AdGroupStatus", "AdStatus", "AssetGroupStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductPartitionUnitPerformanceReportFilter from a dict"""
        if obj is None:
            return None
