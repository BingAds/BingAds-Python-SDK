...
class DSASearchQueryPerformanceReportRequest(ReportRequest):
    """
    ...
    filter: Optional[DSASearchQueryPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[DSASearchQueryPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='DSASearchQueryPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DSASearchQueryPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSASearchQueryPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": DSASearchQueryPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'DSASearchQueryPerformanceReportRequest'
        })
        return _obj
