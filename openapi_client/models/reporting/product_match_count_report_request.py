...
class ProductMatchCountReportRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Scope", "Time", "Aggregation", "Columns", "ReportName", "Format", "ReturnOnlyCompleteData", "ExcludeReportHeader", "ExcludeReportFooter", "ExcludeColumnHeaders", "FormatVersion", "Type"]
