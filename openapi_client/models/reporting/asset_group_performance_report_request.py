...
class AssetGroupPerformanceReportRequest(ReportRequest):
    """
    ...
    scope: Optional[AccountThroughAssetGroupReportScope] = Field(default=None, alias="Scope")
    filter: Optional[AssetGroupPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[AssetGroupPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='AssetGroupPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetGroupPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetGroupPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Scope": AccountThroughAssetGroupReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": AssetGroupPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'AssetGroupPerformanceReportRequest'
        })
        return _obj
