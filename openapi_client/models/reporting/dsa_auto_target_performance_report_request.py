...
class DSAAutoTargetPerformanceReportRequest(ReportRequest):
    """
    ...
    filter: Optional[DSAAutoTargetPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[DSAAutoTargetPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='DSAAutoTargetPerformanceReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DSAAutoTargetPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSAAutoTargetPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": DSAAutoTargetPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'DSAAutoTargetPerformanceReportRequest'
        })
        return _obj
