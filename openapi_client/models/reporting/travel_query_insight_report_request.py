...
class TravelQueryInsightReportRequest(ReportRequest):
    """
    ...
    columns: Optional[List[Optional[TravelQueryInsightReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='TravelQueryInsightReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TravelQueryInsightReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TravelQueryInsightReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'TravelQueryInsightReportRequest'
        })
        return _obj
