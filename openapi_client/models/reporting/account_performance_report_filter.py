...
class AccountPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "DeviceType", "DeviceOS", "AccountStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountPerformanceReportFilter from a dict"""
        if obj is None:
            return None
