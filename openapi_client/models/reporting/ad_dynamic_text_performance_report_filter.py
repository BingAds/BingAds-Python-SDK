...
class AdDynamicTextPerformanceReportFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AdDistribution", "AdType", "DeviceType", "Language", "AccountStatus", "AdGroupStatus", "AdStatus", "KeywordStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdDynamicTextPerformanceReportFilter from a dict"""
        if obj is None:
            return None
