...
class SearchCampaignChangeHistoryReportRequest(ReportRequest):
    """
    ...
    filter: Optional[SearchCampaignChangeHistoryReportFilter] = Field(default=None, alias="Filter")
    time: Optional[ReportTime] = Field(default=None, alias="Time")
    columns: Optional[List[Optional[SearchCampaignChangeHistoryReportColumn]]] = Field(default=None, alias="Columns")
    type: Optional[StrictStr] = Field(default='SearchCampaignChangeHistoryReportRequest', alias="Type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchCampaignChangeHistoryReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchCampaignChangeHistoryReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ReportName": obj.get("ReportName") if obj.get("ReportName") is not None else None,
                        ...
                        "Filter": SearchCampaignChangeHistoryReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        "Time": ReportTime.from_dict(obj["Time"]) if obj.get("Time") is not None else None,
                        "Columns": obj.get("Columns"),
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'SearchCampaignChangeHistoryReportRequest'
        })
        return _obj
