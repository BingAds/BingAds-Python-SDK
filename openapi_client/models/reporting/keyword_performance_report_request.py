...
class KeywordPerformanceReportRequest(ReportRequest):
    ...
    __properties: ClassVar[List[str]] = ["ReportName", "Format", "ReturnOnlyCompleteData", "ExcludeReportHeader", "ExcludeReportFooter", "ExcludeColumnHeaders", "FormatVersion", "Scope", "Filter", "Time", "Aggregation", "Columns", "Sort", "MaxRows", "Type"]
