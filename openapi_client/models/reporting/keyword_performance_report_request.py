...
class KeywordPerformanceReportRequest(BaseModel):
    """
    KeywordPerformanceReportRequest
    """ # noqa: E501
    scope: Optional[AccountThroughAdGroupReportScope] = Field(default=None, alias="Scope")
    filter: Optional[KeywordPerformanceReportFilter] = Field(default=None, alias="Filter")
    ...
    columns: Optional[List[Optional[KeywordPerformanceReportColumn]]] = Field(default=None, alias="Columns")
    sort: Optional[List[Optional[KeywordPerformanceReportSort]]] = Field(default=None, alias="Sort")
    ...
    type: Optional[StrictStr] = Field(default='KeywordPerformanceReportRequest', alias="Type")
    __properties: ClassVar[List[str]] = ["Scope", "Filter", "Time", "Aggregation", "Columns", "Sort", "MaxRows", "ReportName", "Format", "ReturnOnlyCompleteData", "ExcludeReportHeader", "ExcludeReportFooter", "ExcludeColumnHeaders", "FormatVersion", "Type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordPerformanceReportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordPerformanceReportRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Scope": AccountThroughAdGroupReportScope.from_dict(obj["Scope"]) if obj.get("Scope") is not None else None,
                        "Filter": KeywordPerformanceReportFilter.from_dict(obj["Filter"]) if obj.get("Filter") is not None else None,
                        ...
                        "Sort": [KeywordPerformanceReportSort.from_dict(_item) for _item in obj["Sort"]] if obj.get("Sort") is not None else None,
                        "MaxRows": obj.get("MaxRows") if obj.get("MaxRows") is not None else None,
                        ...
                        "Type": obj.get("Type") if obj.get("Type") is not None else 'KeywordPerformanceReportRequest'
        })
        return _obj
