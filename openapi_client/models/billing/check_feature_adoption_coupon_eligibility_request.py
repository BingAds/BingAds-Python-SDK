...
class CheckFeatureAdoptionCouponEligibilityRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["FeatureId", "AccountIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckFeatureAdoptionCouponEligibilityRequest from a dict"""
        if obj is None:
            return None
