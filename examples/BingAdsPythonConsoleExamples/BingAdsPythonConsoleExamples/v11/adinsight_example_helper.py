...
def output_bidlandscapepoint(data_object):
    ...
    output_status_message("Currency: {0}".format(data_object.Currency))
...
def output_keyworddemographic(data_object):
    ...
    output_status_message("Age18_24: {0}".format(data_object.Age18_24))
    output_status_message("Age25_34: {0}".format(data_object.Age25_34))
    output_status_message("Age35_49: {0}".format(data_object.Age35_49))
    output_status_message("Age50_64: {0}".format(data_object.Age50_64))
    output_status_message("Age65Plus: {0}".format(data_object.Age65Plus))
...
def output_currency(value_set):
    output_status_message("Values in {0}".format(value_set.Type))
    for value in value_set['string']:
        output_status_message(value)

def output_array_of_currency(value_sets):
    if value_sets is None or len(value_sets) == 0:
        return
    output_status_message("Array Of Currency:\n")
    for value_set in value_sets['Currency']:
        output_currency(value_set)
