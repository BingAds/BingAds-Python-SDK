...
def output_insertionorder(data_object):
    ...
    output_status_message("InsertionOrderId: {0}".format(data_object.InsertionOrderId))
    ...
    output_status_message("ChangePendingReview: {0}".format(data_object.ChangePendingReview))
