...
def main(authorization_data):
    ...
    try:
        ...
        for entity in get_sample_bulk_sitelink_ad_extensions(authorization_data.account_id):
...
def get_sample_bulk_sitelink_ad_extensions(account_id):
    entities=[]

    for index in range(2):
        bulk_sitelink_ad_extension=BulkSitelinkAdExtension()
        bulk_sitelink_ad_extension.account_id=account_id
        ...
        sitelink_ad_extension.DisplayText = "Women's Shoe Sale " + str(index+1)
        ...
        sitelink_ad_extension.Status=None
        ...
        entities.append(bulk_sitelink_ad_extension)
    ...
    entities.append(bulk_campaign_sitelink_ad_extension)
