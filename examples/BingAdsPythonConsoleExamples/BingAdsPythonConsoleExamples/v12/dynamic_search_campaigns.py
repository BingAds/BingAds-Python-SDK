...
def main(authorization_data):
    ...
    try:
        ...
        failure_webpage_parameter=set_elements_to_none(campaign_service.factory.create('WebpageParameter'))
        failure_webpage_parameter.Conditions=conditions
        failure_webpage_parameter.CriterionName='Update Attempt Failure'

        update_criterion_attempt_failure=set_elements_to_none(campaign_service.factory.create('Webpage'))
        update_criterion_attempt_failure.Type='Webpage'
        update_criterion_attempt_failure.Parameter=failure_webpage_parameter
        
        success_webpage_parameter=set_elements_to_none(campaign_service.factory.create('WebpageParameter'))
        success_webpage_parameter.Conditions=None
        success_webpage_parameter.CriterionName='Update Attempt Success'

        update_criterion_attempt_success=set_elements_to_none(campaign_service.factory.create('Webpage'))
