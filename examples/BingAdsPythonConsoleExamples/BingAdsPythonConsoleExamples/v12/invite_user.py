...
def main(authorization_data):
    ...
    try:
        ...
        pending_invitation=next((invitation for invitation in user_invitations['UserInvitation'] if 
        ...
        for info in users_info:            
            get_user_response=customer_service.GetUser(info.Id)
            output_user(get_user_response.User)
            output_array_of_customerrole(get_user_response.CustomerRoles)
