...
def output_insertionorder(data_object):
    ...
    output_status_message("AccountNumber: {0}".format(data_object.AccountNumber))
    output_status_message("BudgetRemaining: {0}".format(data_object.BudgetRemaining))
    output_status_message("BudgetSpent: {0}".format(data_object.BudgetSpent))
    output_status_message("BudgetRemainingPercent: {0}".format(data_object.BudgetRemainingPercent))
    output_status_message("BudgetSpentPercent: {0}".format(data_object.BudgetSpentPercent))
    output_status_message("SeriesName: {0}".format(data_object.SeriesName))
    output_status_message("IsInSeries: {0}".format(data_object.IsInSeries))
    output_status_message("SeriesFrequencyType: {0}".format(data_object.SeriesFrequencyType))
