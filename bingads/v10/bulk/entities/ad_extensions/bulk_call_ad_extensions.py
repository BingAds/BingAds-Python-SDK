...
_CallAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V10.create('CallAdExtension'))
...
class BulkCallAdExtension(_BulkAdExtensionBase):
    ...
    For more information, see Call Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620234.
    ...
    * :class:`.BulkFileWriter`
    ...
    def call_ad_extension(self):
        ...
        see Call Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620234.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self.call_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V10.create('CallAdExtension')
...
class BulkCampaignCallAdExtension(_BulkCampaignAdExtensionAssociation):
    ...
    For more information, see Campaign Call Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620249.
