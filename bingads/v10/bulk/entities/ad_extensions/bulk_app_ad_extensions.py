...
_AppAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V10.create('AppAdExtension'))
...
class BulkAppAdExtension(_BulkAdExtensionBase):
    ...
    For more information, see App Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620280.
    ...
    * :class:`.BulkFileWriter`
    ...
    def app_ad_extension(self):
        ...
        see App Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620280.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self.app_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V10.create('AppAdExtension')
...
class BulkCampaignAppAdExtension(_BulkCampaignAdExtensionAssociation):
    ...
    For more information, see Campaign App Ad Extension at http://go.microsoft.com/fwlink/?LinkID=620282.
