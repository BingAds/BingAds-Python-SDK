...
class BulkCalloutAdExtension(_BulkAdExtensionBase):
    ...
    For more information, see Callout Ad Extension at http://go.microsoft.com/fwlink/?LinkID=730543.
    ...
    * :class:`.BulkFileWriter`
    ...
    def callout_ad_extension(self):
        ...
        see Callout Ad Extension at http://go.microsoft.com/fwlink/?LinkID=730543.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self.callout_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V10.create('CalloutAdExtension')
...
class BulkCampaignCalloutAdExtension(_BulkCampaignAdExtensionAssociation):
    ...
    For more information, see Campaign Callout Ad Extension at http://go.microsoft.com/fwlink/?LinkID=730545.
...
class BulkAdGroupCalloutAdExtension(_BulkAdGroupAdExtensionAssociation):
    ...
    For more information, see Ad Group Callout Ad Extension at http://go.microsoft.com/fwlink/?LinkID=730544.
