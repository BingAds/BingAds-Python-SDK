...
class BulkAdGroupNegativeSites(_BulkNegativeSites):
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_data_from_identifier(self, identifier):
        self._ad_group_negative_sites = _CAMPAIGN_OBJECT_FACTORY_V10.create('AdGroupNegativeSites')
...
class BulkCampaignNegativeSites(_BulkNegativeSites):
    ...
    For more information, see Campaign Negative Site at http://go.microsoft.com/fwlink/?LinkID=620254.
