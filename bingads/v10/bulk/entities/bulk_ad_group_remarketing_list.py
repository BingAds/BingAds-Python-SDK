...
class BulkAdGroupRemarketingList(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def __init__(self,
                 ...
                 campaign_name=None,
                 ad_group_name=None):
        super(BulkAdGroupRemarketingList, self).__init__()
    ...
    _MAPPINGS = [
        _SimpleBulkMapping(
            _StringTable.Status,
            field_to_csv=lambda c: c.ad_group_remarketing_list_association.Status,
            csv_to_field=lambda c, v: setattr(c.ad_group_remarketing_list_association, 'Status', v)
        ),
        _SimpleBulkMapping(
            _StringTable.Id,
    ...
    def process_mappings_to_row_values(self, row_values, exclude_readonly_data):
        ...
        self.convert_to_values(row_values, BulkAdGroupRemarketingList._MAPPINGS)
    ...
    def process_mappings_from_row_values(self, row_values):
        ...
        row_values.convert_to_entity(self, BulkAdGroupRemarketingList._MAPPINGS)

    def read_additional_data(self, stream_reader):
        super(BulkAdGroupRemarketingList, self).read_additional_data(stream_reader)
