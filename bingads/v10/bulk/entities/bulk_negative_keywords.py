...
class _BulkNegativeKeyword(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkSharedNegativeKeyword`
    ...
    def process_mappings_from_row_values(self, row_values):
        self._negative_keyword = _CAMPAIGN_OBJECT_FACTORY_V10.create('NegativeKeyword')
...
class BulkCampaignNegativeKeywordList(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def shared_entity_association(self):
        ...
        see Campaign Negative Keyword List Association at http://go.microsoft.com/fwlink/?LinkID=620241.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self._shared_entity_association = _CAMPAIGN_OBJECT_FACTORY_V10.create('SharedEntityAssociation')
...
class BulkNegativeKeywordList(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def negative_keyword_list(self):
        ...
        see Negative Keyword List at http://go.microsoft.com/fwlink/?LinkID=620237.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self._negative_keyword_list = _CAMPAIGN_OBJECT_FACTORY_V10.create('NegativeKeywordList')
