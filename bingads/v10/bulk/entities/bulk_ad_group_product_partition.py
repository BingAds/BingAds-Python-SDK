...
_BiddableAdGroupCriterion = type(_CAMPAIGN_OBJECT_FACTORY_V10.create('BiddableAdGroupCriterion'))
_NegativeAdGroupCriterion = type(_CAMPAIGN_OBJECT_FACTORY_V10.create('NegativeAdGroupCriterion'))
