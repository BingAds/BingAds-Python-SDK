...
class DownloadParameters:
    ...
    def __init__(self,
        ...
        :param data_scope: (optional) The scope or types of data to download.
                            For possible values, see DataScope Value Set at http://go.microsoft.com/fwlink/?LinkId=620271.
        :type data_scope: list[str]
        :param entities: (optional) The type of entities to download.
                            For possible values, see BulkDownloadEntity Value Set at http://go.microsoft.com/fwlink/?LinkId=620272.
        :type entities: list[str]
        :param file_type: (optional) The extension type of the downloaded file.
                            For possible values, see DownloadFileType Value Set at http://go.microsoft.com/fwlink/?LinkId=620273.
        :type file_type: str
