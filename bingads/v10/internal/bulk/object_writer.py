from bingads.manifest import BULK_FORMAT_VERSION_4
from bingads.v10.bulk import DownloadFileType

from bingads.v10.internal.bulk.bulk_object_factory import _BulkObjectFactory
from bingads.v10.internal.bulk.csv_writer import _CsvWriter
from bingads.v10.internal.bulk.csv_headers import _CsvHeaders
from bingads.v10.internal.bulk.row_values import _RowValues
...
class _BulkObjectWriter():
    ...
    def write_format_version(self):
        ...
        version_row[_StringTable.Name] = BULK_FORMAT_VERSION_4
