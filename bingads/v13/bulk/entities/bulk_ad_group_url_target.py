...
class BulkAdGroupUrlTarget(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def __init__(self,
        ...
        super(BulkAdGroupUrlTarget, self).__init__()
    ...
    def process_mappings_to_row_values(self, row_values, exclude_readonly_data):
        ...
        self.convert_to_values(row_values, BulkAdGroupUrlTarget._MAPPINGS)

    def read_additional_data(self, stream_reader):
        super(BulkAdGroupUrlTarget, self).read_additional_data(stream_reader)
