...
class _BulkObjectFactory():
    INDIVIDUAL_ENTITY_MAP = {
        ...
        _StringTable.CampaignNegativeAgeCriterion: _EntityInfo(lambda: BulkCampaignNegativeAgeCriterion()),
        _StringTable.CampaignNegativeGenderCriterion: _EntityInfo(lambda: BulkCampaignNegativeGenderCriterion()),
        ...
        _StringTable.AccountContentNegativeKeywordList: _EntityInfo(lambda: BulkAccountContentNegativeKeywordList()),
        _StringTable.AccountContentNegativeKeywordListAssociation: _EntityInfo(lambda: BulkAccountContentNegativeKeywordListAssociation()),
        _StringTable.AccountContentSharedNegativeKeyword: _EntityInfo(lambda: BulkAccountContentSharedNegativeKeyword()),
        ...
        _StringTable.AppDownloadGoal: _EntityInfo(lambda: BulkAppDownloadGoal()),
