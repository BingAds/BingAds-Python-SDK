...
class BulkAdGroupSimilarRemarketingListAssociation(_SingleRecordBulkEntity):
    ...
    Ad Group Similar Remarketing List Association record in a bulk file.
    ...
    * :class:`.BulkFileWriter`
    ...
    def __init__(self,
        ...
        super(BulkAdGroupSimilarRemarketingListAssociation, self).__init__()
    ...
    def process_mappings_from_row_values(self, row_values):
        ...
        row_values.convert_to_entity(self, BulkAdGroupSimilarRemarketingListAssociation._MAPPINGS)
    ...
    def process_mappings_to_row_values(self, row_values, exclude_readonly_data):
        ...
        self.convert_to_values(row_values, BulkAdGroupSimilarRemarketingListAssociation._MAPPINGS)

        PerformanceData.write_to_row_values_if_not_null(self._performance_data, row_values)
    
    def read_additional_data(self, stream_reader):
        super(BulkAdGroupSimilarRemarketingListAssociation, self).read_additional_data(stream_reader)
