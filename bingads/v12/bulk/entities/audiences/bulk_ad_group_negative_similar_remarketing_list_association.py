...
class BulkAdGroupNegativeSimilarRemarketingListAssociation(_SingleRecordBulkEntity):
    ...
    Ad Group Negative Similar Remarketing List Association record in a bulk file.
    ...
    * :class:`.BulkFileWriter`
    ...
    def __init__(self,
                 ...
                 campaign_name=None,
                 ad_group_name=None,
                 similar_remarketing_list_name=None):
        super(BulkAdGroupNegativeSimilarRemarketingListAssociation, self).__init__()

        self._negative_ad_group_criterion = negative_ad_group_criterion
        self._campaign_name = campaign_name
        self._ad_group_name = ad_group_name
        self._similar_remarketing_list_name = similar_remarketing_list_name
    ...
    _MAPPINGS = [
        ...
        _SimpleBulkMapping(
            ...
            field_to_csv=lambda c: c.similar_remarketing_list_name,
            csv_to_field=lambda c, v: setattr(c, 'similar_remarketing_list_name', v)
        ),
        _SimpleBulkMapping(
    ...
    @property
    def similar_remarketing_list_name(self):
        """ Defines the name of the Remarketing List

        :rtype: str
        """

        return self._similar_remarketing_list_name

    @similar_remarketing_list_name.setter
    def similar_remarketing_list_name(self, similar_remarketing_list_name):
        self._similar_remarketing_list_name = similar_remarketing_list_name
    ...
    def process_mappings_from_row_values(self, row_values):
        ...
        row_values.convert_to_entity(self, BulkAdGroupNegativeSimilarRemarketingListAssociation._MAPPINGS)

    def process_mappings_to_row_values(self, row_values, exclude_readonly_data):
        self._validate_property_not_null(self.negative_ad_group_criterion, 'negative_ad_group_criterion')
        self.convert_to_values(row_values, BulkAdGroupNegativeSimilarRemarketingListAssociation._MAPPINGS)
    
    def read_additional_data(self, stream_reader):
        super(BulkAdGroupNegativeSimilarRemarketingListAssociation, self).read_additional_data(stream_reader)
