...
_StructuredSnippetAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V12.create('StructuredSnippetAdExtension'))
...
class BulkStructuredSnippetAdExtension(_BulkAdExtensionBase):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.structured_snippet_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V12.create('StructuredSnippetAdExtension')
