...
_CalloutAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V12.create('CalloutAdExtension'))
...
class BulkCalloutAdExtension(_BulkAdExtensionBase):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.callout_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V12.create('CalloutAdExtension')
