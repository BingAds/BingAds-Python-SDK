...
_ReviewAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V12.create('ReviewAdExtension'))
...
class BulkReviewAdExtension(_BulkAdExtensionBase):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.review_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V12.create('ReviewAdExtension')
