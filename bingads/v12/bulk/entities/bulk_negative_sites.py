...
from bingads.v12.internal.bulk.entities.multi_record_bulk_entity import _MultiRecordBulkEntity
...
class BulkAdGroupNegativeSites(_BulkNegativeSites):
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_data_from_identifier(self, identifier):
        self._ad_group_negative_sites = _CAMPAIGN_OBJECT_FACTORY_V12.create('AdGroupNegativeSites')
...
class BulkCampaignNegativeSites(_BulkNegativeSites):
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_data_from_identifier(self, identifier):
        self._campaign_negative_sites = _CAMPAIGN_OBJECT_FACTORY_V12.create('CampaignNegativeSites')
