...
class BulkAppAdExtension(_BulkAdExtensionBase):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.app_ad_extension = _CAMPAIGN_OBJECT_FACTORY.create('AppAdExtension')
...
class BulkCampaignAppAdExtension(_BulkCampaignAdExtensionAssociation):
    ...
    For more information, see Campaign App Ad Extension at http://go.microsoft.com/fwlink/?LinkID=515903.
...
class BulkAdGroupAppAdExtension(_BulkAdGroupAdExtensionAssociation):
    ...
    For more information, see Ad Group App Ad Extension at http://go.microsoft.com/fwlink/?LinkID=515902.
