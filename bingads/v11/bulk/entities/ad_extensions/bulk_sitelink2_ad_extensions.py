...
_Sitelink2AdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V11.create('Sitelink2AdExtension'))
...
class BulkSitelink2AdExtension(_BulkAdExtensionBase):
    ...
    For more information, see Sitelink2 Ad Extension at https://go.microsoft.com/fwlink/?linkid=846127.
    ...
    * :class:`.BulkFileWriter`
    ...
    def sitelink2_ad_extension(self):
        ...
        see Sitelink2 Ad Extension at https://go.microsoft.com/fwlink/?linkid=846127.
        """
    ...
    def process_mappings_from_row_values(self, row_values):
        self.sitelink2_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V11.create('Sitelink2AdExtension')
...
class BulkCampaignSitelink2AdExtension(_BulkCampaignAdExtensionAssociation):
    ...
    For more information, see Campaign Sitelink2 Ad Extension at https://go.microsoft.com/fwlink/?linkid=846127.
...
class BulkAdGroupSitelink2AdExtension(_BulkAdGroupAdExtensionAssociation):
    ...
    For more information, see Ad Group Sitelink2 Ad Extension at https://go.microsoft.com/fwlink/?linkid=846127.
