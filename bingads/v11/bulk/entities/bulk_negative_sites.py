...
class BulkAdGroupNegativeSites(_BulkNegativeSites):
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_data_from_identifier(self, identifier):
        self._ad_group_negative_sites = _CAMPAIGN_OBJECT_FACTORY_V11.create('AdGroupNegativeSites')
...
class BulkCampaignNegativeSites(_BulkNegativeSites):
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_data_from_identifier(self, identifier):
        self._campaign_negative_sites = _CAMPAIGN_OBJECT_FACTORY_V11.create('CampaignNegativeSites')
